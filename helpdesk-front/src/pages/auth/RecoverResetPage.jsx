...
import { recoverPassword, cancelSession } from '../../api/auth';
        ...
        return (
            <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#F9FAFB', padding: '20px' }}>
                <div style={{ background: 'white', padding: '40px', borderRadius: '16px', textAlign: 'center' }}>
                    <p style={{ color: '#111827' }}>Ошибка сессии.</p>
                    <a href="/recover" style={{ color: '#4F46E5' }}>Начать заново</a>
                </div>
            </div>
        );
    }
        ...
        <div style={pageStyle}>
            <div style={cardStyle}>
                ...
                <p style={{ textAlign: 'center', color: '#6B7280', marginBottom: '32px', fontSize: '14px' }}>
                    Введите код подтверждения и задайте новый пароль.
                </p>

                <form onSubmit={handleSubmit}>
                    <div style={{ marginBottom: '16px' }}>
                        <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '4px' }}>Код подтверждения</label>
                        <input
                            type="text"
                    ...
                    <div style={{ marginBottom: '16px' }}>
                        <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '4px' }}>Новый пароль</label>
                        <input
                            type="password"
                    ...
                    <button type="submit" style={btnPrimary}>Сохранить и войти</button>
